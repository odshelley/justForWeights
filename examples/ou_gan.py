...
def get_data(batch_size, device):
    ...
    y0 = torch.rand(dataset_size, device=device).unsqueeze(-1) * 2 - .5
...
def main(
    ...
    #                 torch.save(generator.state_dict(), "ou_best_generator.pth")
    #                 torch.save(
    #                     discriminator.state_dict(), "ou_best_discriminator.pth"
    #                 )
    #                 trange.write(
    #                     f"New best model found at step {step}, saving model weights."
    #                 )
